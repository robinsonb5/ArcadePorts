...
create_generated_clock -name sd1clk_pin -source [get_pins {virtualtoplevel|guest|pll|altpll_component|auto_generated|pll1|clk[2]}] [get_ports {ram_clk}]
create_generated_clock -name sysclk -source [get_pins {virtualtoplevel|guest|pll|altpll_component|auto_generated|pll1|clk[1]}]
...
set_multicycle_path -from [get_clocks {sd1clk_pin}] -to [get_clocks {virtualtoplevel|guest|pll|altpll_component|auto_generated|pll1|clk[1]}] -setup -end 2
