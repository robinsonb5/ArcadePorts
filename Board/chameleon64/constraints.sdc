...
create_generated_clock -name sdram_clk_pin -source [get_pins {myproject|guest|pll|altpll_component|auto_generated|pll1|clk[2]}] [get_ports {sdram_clk}]
...
set_multicycle_path -from [get_clocks {sdram_clk_pin}] -to [get_clocks {myproject|guest|pll|altpll_component|auto_generated|pll1|clk[1]}] -setup -end 2
set_multicycle_path -from [get_clocks {sdram_clk_pin}] -to [get_clocks {myproject|guest|pll|altpll_component|auto_generated|pll1|clk[1]}] -setup -end 2
