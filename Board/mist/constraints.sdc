...
derive_pll_clocks 
create_generated_clock -name sd1clk_pin -source [get_pins {myVirtualToplevel|guest|pll|altpll_component|auto_generated|pll1|clk[2]}] [get_ports {SDRAM_CLK}]
...
set_input_delay -clock { sd1clk_pin } -max 5.8 [get_ports SDRAM_*]
set_input_delay -clock { sd1clk_pin } -min 5.8 [get_ports SDRAM_*]
